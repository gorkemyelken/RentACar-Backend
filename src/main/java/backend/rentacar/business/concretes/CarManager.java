...
public class CarManager implements CarService {
    ...
    public DataResult<Car> findByCarId(int carId) {
        return new SuccessDataResult<Car>(this.carDao.findByCarId(carId),"Car listed by id.");
    }

    @Override
    public DataResult<Car> findByCarName(String carName) {
        return new SuccessDataResult<Car>(this.carDao.findByCarName(carName),"Car listed by name.");
    }

    @Override
    public DataResult<List<Car>> findByDailyPrice(double dailyPrice) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByDailyPrice(dailyPrice),"Car listed by daily price.");
    }

    @Override
    public DataResult<List<Car>> findByModelYear(int modelYear) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByModelYear(modelYear),"Car listed by model year.");
    }

    @Override
    public DataResult<List<Car>> findByDailyPriceLessThan(double dailyPrice) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByDailyPriceLessThan(dailyPrice),"Cars are less than the entered daily price are listed.");
    }

    @Override
    public DataResult<List<Car>> findByDailyPriceGreaterThan(double dailyPrice) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByDailyPriceGreaterThan(dailyPrice),"Cars are greater than the entered daily price are listed.");
    }

    @Override
    public DataResult<List<Car>> findByDailyPriceBetween(double startDailyPrice, double endDailyPrice) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByDailyPriceBetween(startDailyPrice, endDailyPrice),"Cars in the entered daily price range are listed.");
    }

    @Override
    public DataResult<List<Car>> findByModelYearLessThan(int modelYear) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByModelYearLessThan(modelYear),"Cars are less than the entered model year are listed.");
    }

    @Override
    public DataResult<List<Car>> findByModelYearGreaterThan(int modelYear) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByModelYearGreaterThan(modelYear),"Cars are greater than the entered model year are listed.");
    }

    @Override
    public DataResult<List<Car>> findByModelYearBetween(int startModelYear, int endModelYear) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByModelYearBetween(startModelYear, endModelYear),"Cars in the entered model year range are listed.");
    }

    @Override
    public DataResult<List<Car>> findByDescriptionContaining(String infix) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByDescriptionContaining(infix),"Cars matching the description entered are listed.");
    }

    @Override
    public DataResult<List<Car>> findByBrand(int brandId) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByBrand_BrandId(brandId),"Cars matching the brand entered are listed.");
    }

    @Override
    public DataResult<List<Car>> findByColor(int colorId) {
        return new SuccessDataResult<List<Car>>(this.carDao.findByColor_ColorId(colorId),"Cars matching the color entered are listed.");
    }

    @Override
    public DataResult<List<CarWithBrandDto>> getCarWithBrandDetails() {
        return new SuccessDataResult<List<CarWithBrandDto>>(this.carDao.getCarWithBrandDetails(),"Cars listed with brand.");
    }

    @Override
    public DataResult<List<CarWithColorDto>> getCarWithColorDetails() {
        return new SuccessDataResult<List<CarWithColorDto>>(this.carDao.getCarWithColorDetails(),"Cars listed with color.");
    }
}
